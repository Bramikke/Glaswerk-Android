package com.bramgoedvriend.glaswerk.students.studentDetail
...
class StudentDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val student = StudentDetailFragmentArgs.fromBundle(arguments!!).student
        if (student != null) {
        ...
        val viewModelFactory = StudentDetailViewModelFactory(application)
        studentDetailViewModel =
            ViewModelProviders.of(this, viewModelFactory).get(StudentDetailViewModel::class.java)
